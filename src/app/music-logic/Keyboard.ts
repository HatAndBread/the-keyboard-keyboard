...
export default class Keyboard {
  ...
  constructor(name: string, assignments: { [key: string]: Player }) {
    ...
    this.o = assignments.c;
    this.p = assignments.c;
    this.q = assignments.c;
    this.r = assignments.c;
    this.s = assignments.c;
    this.t = assignments.c;
    this.u = assignments.c;
    this.v = assignments.c;
    this.w = assignments.c;
    this.x = assignments.c;
    this.y = assignments.c;
    this.z = assignments.c;
